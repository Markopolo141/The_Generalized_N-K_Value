...
def run(f):
	...
	os.system("python bounds_solver.py burgess {}.json bound_burgess{}out.json 180 980 10 100 --inds_data=inds{}.json".format(f,f,f))
	...
	os.system("python bounds_solver.py maleki {}.json bound_maleki{}out.json 180 1700 10 100 --inds_data=inds{}.json".format(f,f,f))
