...
def run(f):
	...
	os.system("python bounds_solver.py burgess {}.json bound_burgess{}out.json 180 1000 10 60 --inds_data=inds{}.json".format(f,f,f))
	print "--- Solving Network via stratified statistics:SIMPLE"
	os.system("python bounds_solver.py simple {}.json bound_simple{}out.json 180 1700 10 60 --inds_data=inds{}.json".format(f,f,f))
	print "--- Solving Network via stratified statistics:MALEKI"
	os.system("python bounds_solver.py maleki {}.json bound_maleki{}out.json 180 1700 10 60 --inds_data=inds{}.json".format(f,f,f))
